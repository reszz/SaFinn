    ...
    <div className="flex items-center">
      <div className="w-8/12">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-4">
            Have an account?{" "}
            <Link href="/login" className="text-green-500 ml-2">
              Login
            </Link>
          </div>
          <Link
            href="#"
            className="w-5/12 text-center place-content-center items-center h-16 bg-emerald-500 mt-12 rounded-2xl text-2xl">
            Register
          </Link>
        </div>
      </div>
